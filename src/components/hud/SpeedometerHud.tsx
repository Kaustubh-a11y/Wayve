...
export const SpeedometerHud: React.FC = () => {
  ...
  return (
    <div className="absolute top-20 right-4 z-20 flex items-center gap-2 animate-in fade-in duration-300">
      {/* Current Speed Badge */}
      <div className="glass-panel px-3.5 py-2 rounded-2xl flex flex-col items-center justify-center border border-white/10 shadow-lg min-w-[72px]">
        <span
          className={`text-2xl font-black font-mono leading-none tracking-tight ${
            isOverSpeed ? "text-red-500" : "text-emerald-500"
          }`}
        >
      ...
      {/* Speed Limit Sign */}
      <div className="w-12 h-14 rounded-2xl bg-white border-2 border-red-600 flex flex-col items-center justify-center shadow-lg">
        <span className="text-[8px] font-black tracking-tight text-slate-800 leading-none uppercase">
          Limit
        </span>
